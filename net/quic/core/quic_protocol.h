...
// recovery blocks for fec erasure coding
NET_EXPORT_PRIVATE extern size_t kDefaultRecoveryBlocksCount;
...
const QuicByteCount kDefaultMaxPacketSize = 1356;
...
NET_EXPORT_PRIVATE size_t
GetStartOfFecProtectedData(QuicVersion version,
	QuicConnectionIdLength connection_id_length,
	bool include_version,
	bool include_path_id,
	bool include_diversification_nonce,
