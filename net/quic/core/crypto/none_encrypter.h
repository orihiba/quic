...
#ifndef NET_QUIC_CRYPTO_MY_ENCRYPTER_H_
#define NET_QUIC_CRYPTO_MY_ENCRYPTER_H_
...
class NET_EXPORT_PRIVATE MyEncrypter : public QuicEncrypter {
 public:
	 enum {
		 kAuthTagSize = 12,
	 };
  ...
  MyEncrypter();
 // MyEncrypter(const EVP_AEAD* aead_alg,
 //                   size_t key_size,
 //                   size_t auth_tag_size,
 //                   size_t nonce_prefix_size);
  ~MyEncrypter() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(MyEncrypter);
};

}  // namespace net

#endif  // NET_QUIC_CRYPTO_MY_ENCRYPTER_H_
