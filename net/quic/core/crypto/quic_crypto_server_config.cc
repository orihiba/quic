...
QuicServerConfigProtobuf* QuicCryptoServerConfig::GenerateConfig(
 ...
 // base::CommandLine* command_line = base::CommandLine::ForCurrentProcess();
  ...
  // if the user added "--plain" at the command line, the traffic wouldn't be encrypted.
//  if (command_line->HasSwitch("plain")) // TODO HIBA
  //{
	  msg.SetVector(kAEAD, QuicTagVector{ kNone });
  //}
