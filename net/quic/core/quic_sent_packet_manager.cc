...
QuicConnectionStats* QuicSentPacketManager::getStats()
{
	return stats_;
}
QuicPacketNumber QuicSentPacketManager::GetUnackedNumber()
{
	return std::count_if(unacked_packets_.begin(), unacked_packets_.end(), [](TransmissionInfo& x){return true;});
}
