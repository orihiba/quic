...
class QuicNormalClientSession : public QuicNormalClientSessionBase
{
public:
	// Takes ownership of |connection|. Caller retains ownership of
	// |promised_by_url|.
	QuicNormalClientSession(
...
protected:
	...
	// subclasses which want to use a subclass of QuicSpdyClientStream for streams
	// but wish to use the sanity checks in CreateOutgoingDynamicStream.
	virtual QuicNormalStream* CreateClientStream();
...
private:
	...
	DISALLOW_COPY_AND_ASSIGN(QuicNormalClientSession);
};
